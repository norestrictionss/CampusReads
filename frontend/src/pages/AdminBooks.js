  ...
  return (
    <div className='container' id="bookContainer">
      ...
      <div className="card_container">
        <div className="row" id="adminBookPageRow">
        {users.length > 0 ?
                  ...
                  Object.entries(attributes.booklist)
                    ...
                    .map(([bookKey, bookAttribute]) => (
                      <div key={bookKey} className="col-lg-3 col-md-4 col-sm-6 col-12">
                        <AdminBookCard id={bookKey} userId = {key} title={bookAttribute.bookName} author={bookAttribute.author} image={bookAttribute.imageURL} />
                      </div>
                    ))
                }
              </React.Fragment>
