                    ...
                    <div className="col-md-10 mx-auto">
                        <div className="p-3 py-5">
                            ...
                            <form className="row mt-3">
                                <div className="col-md-12"><label htmlFor="ssn" className="labels">Book SSN</label><input name="ssn" type="text" className="form-control" placeholder="enter book ssn" value="" /></div>
                                <div className="col-md-12"><label htmlFor="bookname"className="labels">Name</label><input name="bookname" type="text" className="form-control" placeholder="enter book name" value="" /></div>
                                <div className="col-md-12"><label htmlFor="bookauthor" className="labels">Author</label><input name="bookauthor" type="text" className="form-control" placeholder="enter book author" value="" /></div>
                                <div className="col-md-12"><label htmlFor="bookgender" className="labels">Gender</label><input name="bookgender" type="text" className="form-control" placeholder="enter book gender" value="" /></div>
                                <div className="mb-3">
