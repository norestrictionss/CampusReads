    ...
    return (
        <div className="profile-header">
            ...
            <ul class="profile-header-tab nav nav-tabs">
                ...
                <li class="nav-item"><a href="#" target="__blank" class="nav-link_">PAST SWAPS</a></li>
                <li class="nav-item"><a href="#" target="__blank" class="nav-link_">SENDED REQUESTS</a></li>
                <li class="nav-item"><a href="#" target="__blank" class="nav-link_">NOTIFICATIONS</a></li>
            </ul>
